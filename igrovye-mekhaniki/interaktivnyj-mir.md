...
Если навести перекрестие на плакат в пределах досягаемости (как для активации), он подсветится ванильным контуром Glow. Контур гаснет, как только взгляд уходит в сторону.

## Диктофоны

Диктофоны содержат лорные аудиозаписи. Нажми ПКМ по устройству, чтобы оно поднялось с земли и начало воспроизведение.

Если навести перекрестие на диктофон в пределах досягаемости (как для активации), устройство подсветится ванильным контуром Glow. Контур гаснет, как только взгляд уходит в сторону.
